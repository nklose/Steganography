...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_spacing_info.setGeometry(QtCore.QRect(20, 170, 141, 61))
        ...
        self.btn_process = QtGui.QPushButton(self.group_image)
        self.btn_process.setGeometry(QtCore.QRect(10, 250, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.text_message.setGeometry(QtCore.QRect(180, 20, 811, 211))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Consolas"))
        font.setPointSize(9)
        ...
        self.lbl_num_characters.setGeometry(QtCore.QRect(135, 233, 851, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Consolas"))
        font.setPointSize(10)
        ...
        self.lbl_message_info.setGeometry(QtCore.QRect(10, 70, 151, 91))
        ...
        self.lbl_allowed_symbols.setGeometry(QtCore.QRect(10, 150, 151, 81))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Consolas"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_message_info.setText(_translate("MainWindow", "Enter the message you would like to encode into the box. English letters, numbers, and spaces are supported, plus the following characters:                ", None))
